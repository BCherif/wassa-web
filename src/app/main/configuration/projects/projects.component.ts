...
@Component({
    selector: 'configuration-projects',
...
export class ProjectsComponent implements OnInit {
    ...
    displayedColumns = ['title', 'startDate', 'endDate', 'description', 'buttons'];
    ...
    ngOnInit(): void {
        ...
        this.searchInput.valueChanges
            ...
            .subscribe(searchText => {
                this.filteredProjects = FuseUtils.filterArrayByString(this.projects, searchText);
            });
    }
    ...
    nextPage(event: PageEvent) {
        this._projectsService.pageBody.pageNumber = event.pageIndex;
        this._projectsService.pageBody.pageSize = event.pageSize;
        this.getAll();
    }
