...
export class BudgetsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.searchInput.valueChanges
            ...
            .subscribe(searchText => {
                this.filteredBudgets = FuseUtils.filterArrayByString(this.budgets, searchText);
            });
    }
    ...
    getAll() {
        this._budgetsService.getBudgets(this._budgetsService.pageBody).subscribe(data => {
