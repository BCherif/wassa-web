...
@Component({
    selector: 'staff_management-employees',
...
export class EmployeesComponent implements OnInit {
    ...
    displayedColumns = ['firstname', 'lastname', 'job', 'department', 'buttons'];
    ...
    ngOnInit(): void {
        ...
        this.searchInput.valueChanges
            ...
            .subscribe(searchText => {
                this.filteredEmployees = FuseUtils.filterArrayByString(this.employees, searchText);
            });
    }
    ...
    nextPage(event: PageEvent) {
        this._employeesService.pageBody.pageNumber = event.pageIndex;
        this._employeesService.pageBody.pageSize = event.pageSize;
        this.getAllEmployees();
    }
